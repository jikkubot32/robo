...
log_channel = "-1001356386015"   # Telegram Channel ID where the bot is added and have write permission. You can use group ID too.
check_interval = 2   # Check Interval in seconds.    
max_instances = 30   # Max parallel instance to be used.
